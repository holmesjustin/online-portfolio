        ...
        <div className="cards__wrapper">
          ...
          <ul className="cards__items">
            <CardItem
              ...
              path="/portfolio/holmes-aerial-photography"
            />
            <CardItem
          ...
          <ul className="cards__items">
            <CardItem
              src="images/previous-internships.jpg"
